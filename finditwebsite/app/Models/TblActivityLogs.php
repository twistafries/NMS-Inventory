...
class TblActivityLogs extends Model {
    ...
    public static function get_logs() {
        ...
        ->select('users.fname as firstname','users.lname as lastname', 'users.id as user', 'departments.name as dept_name', 'equipment_status.name as status_name', 'issuance.issued_to as issued_to', 'it_equipment.brand as brand', 'it_equipment.model', 'it_equipment.unit_id as part_unit', 'it_equipment_subtype.name as subtype_name', 'it_equipment_type.name as type_name', 'system_units.description as unit_description', 'a.action as action', 'a.created_at as date_added')
